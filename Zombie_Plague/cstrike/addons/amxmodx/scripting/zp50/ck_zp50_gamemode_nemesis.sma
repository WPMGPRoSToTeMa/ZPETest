...
public plugin_init()
{
	...
	g_pCvar_Message_Notice_Nemesis_Converted = register_cvar("zpe_notice_nemesis_message_converted", "0");
	g_pCvar_Message_Notice_Nemesis_R = register_cvar("zpe_notice_nemesis_message_r", "0");
	g_pCvar_Message_Notice_Nemesis_G = register_cvar("zpe_notice_nemesis_message_g", "250");
	g_pCvar_Message_Notice_Nemesis_B = register_cvar("zpe_notice_nemesis_message_b", "0");
	g_pCvar_Message_Notice_Nemesis_X = register_cvar("zpe_notice_nemesis_message_x", "-1.0");
	g_pCvar_Message_Notice_Nemesis_Y = register_cvar("zpe_notice_nemesis_message_y", "0.75");
	g_pCvar_Message_Notice_Nemesis_Effects = register_cvar("zpe_notice_nemesis_message_effects", "0");
	g_pCvar_Message_Notice_Nemesis_Fxtime = register_cvar("zpe_notice_nemesis_message_fxtime", "0.1");
	g_pCvar_Message_Notice_Nemesis_Holdtime = register_cvar("zpe_notice_nemesis_message_holdtime", "1.5");
	g_pCvar_Message_Notice_Nemesis_Fadeintime = register_cvar("zpe_notice_nemesis_message_fadeintime", "2.0");
	g_pCvar_Message_Notice_Nemesis_Fadeouttime = register_cvar("zpe_notice_nemesis_message_fadeouttime", "1.5");
	g_pCvar_Message_Notice_Nemesis_Channel = register_cvar("zpe_notice_nemesis_message_channel", "-1");
